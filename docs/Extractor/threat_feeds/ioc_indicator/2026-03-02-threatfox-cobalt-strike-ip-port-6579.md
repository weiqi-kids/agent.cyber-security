---
title: "ThreatFox IoC: Cobalt Strike C2 150.241.73.11:443"
...
ioc_type: ip:port
ioc_value: "150.241.73.11:443"
threat_level: High
confidence: 高
first_seen: "2026-03-02T07:28:58Z"
last_seen: null
reporter: abuse_ch
tags:
  - CobaltStrike
...
threatfox_id: "1756579"
---

# ThreatFox IoC: Cobalt Strike C2 150.241.73.11:443
...
|------|----|
| IoC 類型 | ip:port |
| IoC 值 | 150.241.73.11:443 |
| 威脅類型 | botnet（C2 通訊） |
| 惡意程式家族 | Cobalt Strike（BEACON） |
| 威脅等級 | High |
| 可信度 | 高（100%） |
| 首次發現 | 2026-03-02 07:28:58 UTC |
| 最後發現 | — |
| 回報者 | abuse_ch |
| ThreatFox ID | 1756579 |

## IoC 詳情

- **IP:Port**：150.241.73.11:443
- **用途**：Cobalt Strike Beacon C2（Command & Control）伺服器
- **通訊埠**：443（HTTPS，偽裝正常 TLS 流量）
- **Watermark**：987654321（與 #1756580、#1756578 共用，顯示同一 Cobalt Strike 授權或設定檔）
...
- 1.94.186.19:8888（ThreatFox #1756578）

## 封鎖建議

- 封鎖對 150.241.73.11:443 的連線
- 監控 Cobalt Strike Beacon 特徵流量（HTTPS Malleable C2 Profile）
- 搜尋端點是否存在 Cobalt Strike 植入程式（stageless/staged Beacon）
- 使用 Watermark 987654321 進行全面掃描

## 來源

- [ThreatFox #1756579](https://threatfox.abuse.ch/ioc/1756579/)
