# ClearFake 惡意程式 Payload 傳遞域名：dev4work.northoak.in.net
...
此 IoC 屬於 ClearFake（js.clearfake）惡意程式家族。ClearFake 活動通常透過受感染網站植入惡意 JavaScript，引導訪客下載偽裝成瀏覽器更新的惡意載荷，目標為 Windows 系統用戶。與同期其他 northoak.in.net 子域名（dev2power、dev3local）屬同一活動基礎設施。

## 來源連結

- [abuse.ch ThreatFox](https://threatfox.abuse.ch/)
- [ThreatFox IoC ID 1776525](https://threatfox.abuse.ch/ioc/1776525/)
