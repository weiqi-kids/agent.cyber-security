...
abuse.ch ThreatFox 分享的 IoC 指標（威脅類型：payload_delivery；惡意程式：SmartApeSG）。信心水準：100。最後出現：2026-06-17 00:10:51。

## IoC 指標

| 類型 | 值 |
|------|-----|
| url | `hxxps://granitequill.top/token/signin-schema.js` |
