...
|------|------|
| **IoC 類型** | ip |
| **IoC 值** | `203.91.77.124:2087` |
| **惡意軟體家族** | Cobalt Strike |
| **威脅類型** | botnet_cc |
| **信心水準** | 100% |
| **首次發現** | 2026-01-27 |
| **來源** | abuse.ch ThreatFox |
| **標籤** | AROSS-AS,AS400619,C2,censys,CobaltStrike,cs-watermark-666666666 |

## 威脅描述

此 IoC 指標於 2026-01-27 由 abuse.ch ThreatFox 收錄，與惡意軟體家族 Cobalt Strike 相關聯。威脅類型識別為 botnet_cc，信心水準為 100%。
...
- [參考連結](https://search.censys.io/hosts/203.91.77.124)
