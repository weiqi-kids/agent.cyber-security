...
|------|------|
| **IoC 類型** | ip |
| **IoC 值** | `206.189.215.203:4444` |
| **惡意軟體家族** | Cobalt Strike |
| **威脅類型** | botnet_cc |
| **信心水準** | 100% |
| **首次發現** | 2026-01-26 |
| **來源** | abuse.ch ThreatFox |
| **標籤** | AS14061,C2,censys,CobaltStrike,cs-watermark-987654321,DIGITALOCEAN-ASN |

## 威脅描述

此 IoC 指標於 2026-01-26 由 abuse.ch ThreatFox 收錄，與惡意軟體家族 Cobalt Strike 相關聯。威脅類型識別為 botnet_cc，信心水準為 100%。
...
- [參考連結](https://search.censys.io/hosts/206.189.215.203)
