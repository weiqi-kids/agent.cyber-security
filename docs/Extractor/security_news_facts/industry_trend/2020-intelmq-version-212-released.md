...
On 28th January, we released the IntelMQ maintenance version 2.1.2 containing only bugfixes for the 2.1.x release series. The documentation for version 2.1.2 and installation instructions can be found
...
- [IntelMQ Version 2.1.2 released](https://www.cert.at/en/blog/2020/1/intelmq-version-212-released)
