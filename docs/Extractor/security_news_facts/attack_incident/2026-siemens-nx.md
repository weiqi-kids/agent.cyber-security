...
View CSAF
Summary
Siemens NX is affected by multiple file parsing vulnerabilities that could be triggered when the application reads files in CGM format. If a user is tricked to open a malicious file 
...
Siemens
Siemens NX
Stack-based Buffer Overflow, Out-of-bounds Read
...
Remediations
MitigationDo not open untrusted CGM files in affected applications
Vendor fixUpdate to V2512 or later version
...
2026-02-12
2
Initial CISA Republication of Siemens ProductCERT SSA-535115 advisory
