...
View CSAF
Summary
Multiple Siemens products are affected by two local privilege escalation vulnerabilities which could allow an low privileged attacker to load malicious DLLs, potentially leading to a
...
Vendor:Siemens
Product Version:SINEC NMS
Product Status:known_affected


Remediations
Vendor fixUpdate to V4.0 SP2 or later version
...
Vendor:Siemens
Product Version:SINEC NMS, User Management Component (UMC)
Product Status:known_affected


Remediations
Vendor fixUpdate to V2.15.2.1 or later version
Vendor fixUpdate UMC to V2.15.2.1 or later compatible version https://support.industry.siemens.com/cs/document/109996127/
...
2026-02-12
2
Initial CISA Republication of Siemens ProductCERT SSA-311973 advisory
