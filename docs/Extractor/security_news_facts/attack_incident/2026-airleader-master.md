...
Product Version:Airleader GmbH Airleader Master: &lt;=6.381
Product Status:known_affected


Remediations
Vendor fixAirleader recommends that users upgrade Airleader Master to version 6.386 or later.
MitigationUsers of Airleader Master are encouraged to reach out to Airleader via email or submit a web form for more information and mitigation assistance.
MitigationUsers of Airleader Master are encouraged to reach out to Airleader via email or submit a web form for more information and mitigation assistance.
