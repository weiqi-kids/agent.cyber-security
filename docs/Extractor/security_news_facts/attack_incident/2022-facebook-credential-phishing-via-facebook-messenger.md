...
Facebook Messenger is being actively used for phishing Facebook user credentials. In the attempts, a hacked account is used to send messages with the aim of obtaining the recipients' telephone numbers...
...
- [Facebook credential phishing via Facebook Messenger](https://www.kyberturvallisuuskeskus.fi/en/ttn_20012022)
